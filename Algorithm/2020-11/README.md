...
### 11/18 [백준 2252 줄 세우기](https://www.acmicpc.net/problem/2252)
N명의 학생들을 키 순서대로 줄을 세우려고 한다. 각 학생의 키를 직접 재서 정렬하면 간단하겠지만, 마땅한 방법이 없어서 두 학생의 키를 비교하는 방법을 사용하기로 하였다. 그나마도 모든 학생들을 다 비교해 본 것이 아니고, 일부 학생들의 키만을 비교해 보았다.

일부 학생들의 키를 비교한 결과가 주어졌을 때, 줄을 세우는 프로그램을 작성하시오.

- [BJ2252.cpp](https://github.com/Seulwoo/DailyStudy/blob/main/Algorithm/2020-11/BJ2252.cpp)
    골드2난이도 문제, 위상 정렬 문제를 처음 풀어봐서 답을 참고하긴 했지만 재미있었다. 위상 정렬 유형을 더 풀어보아야겠다.
    
### 11/19 [백준 1766 문제집](https://www.acmicpc.net/problem/1766)
...
- [BJ1766.cpp](https://github.com/Seulwoo/DailyStudy/blob/main/Algorithm/2020-11/BJ1766.cpp)
    이전 문제랑 비슷한 위상 정렬 문제! 단, 문제를 하나 풀 때마다 풀 수 있는 문제가 업데이트 되어야 하고 그중에서 가장 번호가 낮은 문제를 풀어야 하기 때문에 오름차순 priority queue를 사용했다.
    
### 11/19 [백준 1965 상자넣기](https://www.acmicpc.net/problem/1965)
...
- [BJ1965.cpp](https://github.com/Seulwoo/DailyStudy/blob/main/Algorithm/2020-11/BJ1965.cpp)
    가장 긴 오름차순 순열? 을 구하는 문제랑 똑같은 것 같다! dp를 이용해서 풀었다
    
### 11/21 [백준 16571 알파 틱택토](https://www.acmicpc.net/problem/16571)
...
- [BJ16571.cpp](https://github.com/Seulwoo/DailyStudy/blob/main/Algorithm/2020-11/BJ16571.cpp)
